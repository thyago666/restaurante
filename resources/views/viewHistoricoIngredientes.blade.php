...
<body>
    <div class="container">
    <form method="post" action="{{url('/historico/ingrediente')}}">
        @csrf
    <div class="form-group">
         <label for="exampleFormControlSelect1"><b>Selecione o ingrediente para pesquisa</b></label>
        <select class="form-control" id="id_ingrediente" name="selectIngrediente">
